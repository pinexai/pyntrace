...
class DriftReport:
    ...
    def summary(self) -> None:
        ...
        print(f"\n[pyntrace] Drift Report — {self.baseline_experiment}")
...
class DriftDetector:
    ...
    def _handle_drift(self, report: DriftReport) -> None:
        msg = f"[pyntrace] Drift detected in '{self._baseline_experiment}': score delta={report.score_delta:+.3f}, cost delta={report.cost_delta_pct:+.1f}%"
