...
def auto_dataset(
    ...
    Args:
        ...
        db_path: optional path to agentra SQLite database
    ...
    print(f"[agentra] Generating {n} test cases for {fn_name!r} (focus={focus!r})...")
    ...
    print(f"[agentra] Generated {len(ds)} test cases")
    return ds
