...
class ModelFingerprint:
    ...
    def summary(self) -> None:
        print(f"\n[agentra] Model Fingerprint Summary")
    ...
    def _persist(self) -> None:
        try:
            ...
            print(f"[agentra] Warning: could not persist fingerprint: {e}")
...
def fingerprint(
    ...
    print(f"\n[agentra] Fingerprinting {len(model_names)} model(s) across {len(plugin_names)} attack plugin(s)...")
