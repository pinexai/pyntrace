"""Multi-Agent Trust Exploitation Scanner — agentra v0.2.0.
...
class SwarmScanReport:
    ...
    def _persist(self) -> None:
        ...
        try:
            ...
            print(f"[agentra] Warning: could not persist swarm report: {e}")
        finally:
            conn.close()
...
def scan_swarm(
    ...
    """
    from agentra.providers import _DEFAULT_JUDGE_MODEL
    ...
    for attack_type in attacks:
        ...
        for i, payload in enumerate(payloads):
            ...
            try:
                ...
                print(f"[agentra] Warning: swarm run error: {e}")
