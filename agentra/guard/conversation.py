"""agentra multi-turn conversation attack scanner."""
...
class ConversationScanReport:
    ...
    def summary(self) -> None:
        print(f"\n[agentra] Multi-Turn Scan — {self.fn_name}")
...
def scan_conversation(
    ...
    print(f"[agentra] Running {total} multi-turn conversation attacks on {fn_name}...")
    ...
    for i in range(total):
        ...
        print(f"\r[agentra] {i + 1}/{total} turns tested...", end="", flush=True)
