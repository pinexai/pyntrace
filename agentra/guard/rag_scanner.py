...
class RAGScanReport:
    ...
    def summary(self) -> None:
        print(f"\n[agentra] RAG Security Scan Report")
    ...
    def _persist(self) -> None:
        try:
            ...
            print(f"[agentra] Warning: could not persist RAG report: {e}")
...
def scan_rag(
    ...
    print(f"[agentra] Scanning {len(documents)} documents for security issues...")
