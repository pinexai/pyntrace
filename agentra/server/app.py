...
<div class="header">
  <div class="header-left">
    <h1>agentra <span class="badge">v0.4.0</span></h1>
  </div>
...
const EMPTY_STATES = {
  security:   { ei: '🔍', title: 'No scans yet',            desc: 'Run your first red team scan to see results here.',            cmd: 'agentra scan myapp:chatbot' },
  mcp:        { ei: '🔌', title: 'No MCP scans',            desc: 'Scan an MCP server for security vulnerabilities.',             cmd: 'agentra scan-mcp http://localhost:3000' },
  eval:       { ei: '📊', title: 'No experiments',          desc: 'Run an evaluation experiment to compare model outputs.',       cmd: 'agentra eval run experiment.py' },
  monitor:    { ei: '📡', title: 'No traces yet',           desc: 'Initialize agentra to start recording production traces.',     cmd: 'import agentra; agentra.init()' },
  costs:      { ei: '💰', title: 'No cost data',            desc: 'Initialize agentra to start tracking LLM API costs.',         cmd: 'import agentra; agentra.init()' },
  review:     { ei: '✅', title: 'Queue is empty',          desc: 'All annotations are up to date. Nothing to review.',          cmd: null },
  compliance: { ei: '📋', title: 'No compliance reports',   desc: 'Generate a compliance report for your framework.',            cmd: 'agentra compliance --framework owasp_llm_top10' },
