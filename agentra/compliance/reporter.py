...
# OWASP LLM Top 10 → agentra plugin/scanner mapping
_OWASP_CONTROLS = [
    {
        "control_id": "LLM01",
...
class ComplianceReport:
    ...
    def summary(self) -> None:
        ...
        print(f"\n[agentra] Compliance Report — {self.framework.upper()}")
...
<html>
<head>
<title>agentra Compliance Report — {self.framework}</title>
<style>
...
<body>
<h1>agentra Compliance Report</h1>
...
<p style="margin-top:40px;color:#888;font-size:12px">Generated by <a href="https://github.com/pinexai/agentra">agentra</a></p>
</body>
</html>"""
        with open(path, "w") as f:
            f.write(html)
        print(f"[agentra] Compliance report saved to {path}")
    ...
    for control in controls:
        ...
        if plugin is None or rate is None:
            ...
            if not scans:
                ...
                remediation = f"Run agentra scan to test {control['control_name']}"
            else:
                status = "partial"
