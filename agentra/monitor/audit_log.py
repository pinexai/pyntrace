"""Structured JSON audit log → ~/.agentra/audit.log.
...
_DEFAULT_AUDIT_LOG = Path.home() / ".agentra" / "audit.log"
...
def _get_logger() -> logging.Logger:
    ...
    log_path = Path(os.getenv("AGENTRA_AUDIT_LOG", str(_DEFAULT_AUDIT_LOG)))
    ...
    _logger = logging.getLogger("agentra.audit")
