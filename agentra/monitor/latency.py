"""agentra latency profiler — p50/p95/p99 benchmarking for LLM functions."""
...
class LatencyReport:
    ...
    def summary(self) -> None:
        ...
        print(f"\n[agentra] Latency Benchmark — {self.fn_name}")
...
def benchmark_latency(
    ...
    for i, prompt in enumerate(prompts, 1):
        print(f"\r[agentra] Benchmarking {i}/{total} prompts...", end="", flush=True)
