...
class DriftReport:
    ...
    def summary(self) -> None:
        ...
        print(f"\n[agentra] Drift Report — {self.baseline_experiment}")
...
class DriftDetector:
    ...
    def _handle_drift(self, report: DriftReport) -> None:
        msg = f"[agentra] Drift detected in '{self._baseline_experiment}': score delta={report.score_delta:+.3f}, cost delta={report.cost_delta_pct:+.1f}%"
    ...
    def _send_alert(self, msg: str, report: DriftReport) -> None:
        ...
        try:
            ...
            print(f"[agentra] Alert webhook failed: {e}")
